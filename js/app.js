...
var allModels = [{modelName: 'A simple plant (ver. 2)', modelURL: unloadedPhoto, difficulty: 6, tags: ['Flower', 'Living'], description: 'null', webLink: '/flower-2', time: '12-20 min'}, {modelName: 'Tall plant', modelURL: unloadedPhoto, difficulty: 7, tags: ['Flower', 'Living'], description: 'null', webLink: '/tall-plant', time: '15-25 min'}, {modelName: 'Sea shrimp', modelURL: 'https://pitchk.github.io/h/shrimp.jpg', difficulty: 5.5, tags: ['Living', 'Attacker'], description: 'A small shrimp, complete with two front claws and its distinguishable flexible tail.', webLink: '/sea-shrimp', time: '10-14 min'}, {modelName: 'Attacker fish', modelURL: 'https:/pitchk.github.io/models/attackerfish.jpg', difficulty: 6.5, tags: ['Living', 'Attacker'], description: '(No description provided)', webLink: '/attacker-fish', time: '12-20 min'}];
